...
<%
				Else
					...
					sqlGetLockchain = "SELECT TicketSlipID, IsWinner FROM TicketSlips WHERE TicketTypeID = 5 AND IsWinner IS NOT NULL AND AccountID = " & Session.Contents("AccountID") & " AND InsertDateTime > '1/1/2023' ORDER BY InsertDateTime DESC"
