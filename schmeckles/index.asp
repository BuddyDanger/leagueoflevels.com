...
%>
							...
							<h4 class="text-left bg-dark text-white p-3 mt-0 mb-0 rounded-top"><b>TOP 2022 PAYOUTS</b><span class="float-right dripicons-trophy"></i></h4>

							<ul class="list-group list-group-flush">
<%
								sqlGetLargest = "SELECT TOP (5) TransactionDate, TransactionTotal, TransactionHash, Accounts.ProfileName, Accounts.ProfileImage FROM SchmeckleTransactions INNER JOIN Accounts ON Accounts.AccountID = SchmeckleTransactions.AccountID WHERE TransactionDate >= '9/1/2022' AND TransactionTypeID = 1008 ORDER BY TransactionTotal DESC"
