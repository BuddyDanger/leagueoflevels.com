...
sqlGetTickets = sqlGetTickets & "WHERE TicketSlips.DateProcessed IS NULL AND Matchups.TeamPMR1 = 0 AND Matchups.TeamPMR2 = 0"
...
If Not rsTickets.Eof Then
	...
	WScript.Echo(vbcrlf & "TICKETS SLIPS ARE FUCKING LOADED..." & vbcrlf & vbcrlf)
