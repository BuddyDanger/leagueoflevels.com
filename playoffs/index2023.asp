...
<%
					...
					sqlGetSLFFL = sqlGetSLFFL & "WHERE Levels.LevelID = 2 AND Standings.Year >= " & Session.Contents("CurrentYear") & " AND Standings.Year <= " & Session.Contents("CurrentYear") & " AND Standings.Period >= 1 AND Standings.Period <= " & 14 & " "
					...
					sqlGetSLFFL = sqlGetSLFFL & "INNER JOIN Teams ON Teams.TeamID = Standings.TeamID "
					sqlGetSLFFL = sqlGetSLFFL & "INNER JOIN Levels ON Levels.LevelID = Standings.LevelID "
					sqlGetSLFFL = sqlGetSLFFL & "WHERE Levels.LevelID = 2 AND Standings.Year >= " & Session.Contents("CurrentYear") & " AND Standings.Year <= " & Session.Contents("CurrentYear") & " AND Standings.Period >= 1 AND Standings.Period <= " & 14 & " AND Teams.TeamID NOT IN ( "
